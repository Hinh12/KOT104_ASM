...
import com.example.asm_ph42207.compose.CategoriesSection
import com.example.asm_ph42207.compose.ProductSection
import com.example.asm_ph42207.response.ProductResponse
import com.example.asm_ph42207.viewModel.ViewModelCategory
import com.example.asm_ph42207.viewModel.ViewModelProduct
    ...
    Column(
        ...
        Box(
            modifier = Modifier
                .clickable(
                    onClick = {
                        navController?.navigate("${Screens.ProductDetail.screens}/${model.productID}")
                    }
                )
        ) {
            AsyncImage(
